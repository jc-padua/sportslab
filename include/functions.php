...
{
    global $conn;
    $get_categories = "SELECT DISTINCT product_category FROM products ORDER BY product_category ASC";
...
function viewAllProducts()
{
    ...
    while ($row = mysqli_fetch_assoc($all_product)) {
        ...
        <div class='card w-auto d-flex justify-content-center align-items-center text-center'>
            <div class='card-img'><img src= './admin/products-image/$productImage' class='card-img-top' alt='...'></div>
...
function viewProductCategory()
{
    ...
    if (isset($_GET['product_category'])) {
        ...
        while ($row_products = mysqli_fetch_array($run_products)) {
            ...
            <div class='col col-sm-4 col-md-6 '>
            <div class='card'>
                <img src= './admin/products-image/$pro_img' class='card-img-top' alt='...'>
                <div class='card-body text-center'>
